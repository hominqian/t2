...
# 
# T2 SDE: target/bootdisk/x86-64/build.sh
...
then
	...
	cp $base/target/$target/x86-64/isolinux.cfg isolinux/
	cp $base/target/$target/x86-64/help?.txt isolinux/
